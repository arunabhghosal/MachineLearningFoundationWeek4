...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} TODO: Minimum price of the data}
        \PY{n}{minimum\PYZus{}price} \PY{o}{=} \PY{n}{prices}\PY{o}{.}\PY{n}{min}\PY{p}{(}\PY{p}{)}
...
size. Each of the buckets is used as the testing set 1 time, and acts as
the training set K-1 times. Then the average testing performance is used
...
For client 1: Price is in the range of mean and median. It is
reasonable.
